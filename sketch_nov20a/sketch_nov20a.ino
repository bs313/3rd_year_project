...
#define ONE_WIRE_BUS 6              // data wire is plugged into pin 6 on arduino DS18b20
#include "DHT.h"                     // 
#define DHTPIN 11                     // DHT22 acts as room temperature sensor and humidity sensor PIN 11
...
int temp_sensor1 = 6;        // Pin DS18B20 Sensor is connected to 6


int temp_sensor2 = 11;       // humidity and room temperature sensor pin DHT22


int humidity = 6;            // Pin DS18B20 also measures humidity 
...
int lowerLimit = 32;      //define the lower threshold for the temperature
int upperLimit = 34;      //define the upper threshold for the temperature


              //heat speed, defines how rapid the cooling/heating is   
        
int heatAmount = 255;            // Set heatamount between 0-255 depending on the desired rate of heating
